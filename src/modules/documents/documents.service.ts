 ...
 * on local disk (default: storage/documents - TEMPORARY, not committed to git).
 *
...
export class DocumentsService {
  ...
  constructor(
    ...
    // Configurable via DOCUMENTS_STORAGE_PATH env var, defaults to storage/documents
    const baseDir = process.env.DOCUMENTS_STORAGE_PATH || 'storage/documents';
